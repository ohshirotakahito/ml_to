# -*- coding: utf-8 -*-
"""
Created on Tue May 25 10:28:52 2021
...
##Bnalデータを用いて，アセンブリデータによる修飾分子の識別を行う

#実行ファイルの位置と名前の確認
#akt = __file__
#print(akt)

#tdms_file = TdmsFile.read(r'"D:personal\python\MLUT_NTO\data\bnal.tdms")
path_load ="bnal_data/B@@2021_0522_2317_P53_RKOR_10k_Sample#176 .tdms"
